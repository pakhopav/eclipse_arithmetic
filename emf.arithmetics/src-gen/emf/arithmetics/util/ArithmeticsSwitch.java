...
public class ArithmeticsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ArithmeticsPackage.MODULE: {
			emf.arithmetics.Module module = (emf.arithmetics.Module) theEObject;
		...
		case ArithmeticsPackage.DEFINITION: {
			...
			if (result == null)
				result = caseStatement(definition);
			if (result == null)
				result = caseAbstractDefinition(definition);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ArithmeticsPackage.DECLARED_PARAMETER: {
			...
			if (result == null)
				result = caseAbstractDefinition(declaredParameter);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case ArithmeticsPackage.EVALUATION: {
			...
			if (result == null)
				result = caseStatement(evaluation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseModule(emf.arithmetics.Module object) {
		return null;
	}
