...
public class ArithmeticsFactoryImpl extends EFactoryImpl implements ArithmeticsFactory {
	...
	public static ArithmeticsFactory init() {
		try {
			ArithmeticsFactory theArithmeticsFactory = (ArithmeticsFactory) EPackage.Registry.INSTANCE
					.getEFactory(ArithmeticsPackage.eNS_URI);
	 ...
	 * @generated
	 */
	public emf.arithmetics.Module createModule() {
