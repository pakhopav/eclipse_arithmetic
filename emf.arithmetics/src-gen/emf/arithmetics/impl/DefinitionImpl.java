 ...
 * </p>
 * <ul>
 *   <li>{@link emf.arithmetics.impl.DefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link emf.arithmetics.impl.DefinitionImpl#getArgs <em>Args</em>}</li>
 *   <li>{@link emf.arithmetics.impl.DefinitionImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefinitionImpl extends StatementImpl implements Definition {
	...
	public EList<DeclaredParameter> getArgs() {
		if (args == null) {
			args = new EObjectContainmentEList<DeclaredParameter>(DeclaredParameter.class, this,
					ArithmeticsPackage.DEFINITION__ARGS);
		}
		return args;
	}
	...
	public NotificationChain basicSetExpr(Expression newExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ArithmeticsPackage.DEFINITION__EXPR, oldExpr, newExpr);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpr != expr) {
			...
			if (expr != null)
				msgs = ((InternalEObject) expr).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ArithmeticsPackage.DEFINITION__EXPR, null, msgs);
			if (newExpr != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ArithmeticsPackage.DEFINITION__EXPR, newExpr,
					newExpr));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractDefinition.class) {
			...
			case ArithmeticsPackage.DEFINITION__NAME:
				return ArithmeticsPackage.ABSTRACT_DEFINITION__NAME;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractDefinition.class) {
			...
			case ArithmeticsPackage.ABSTRACT_DEFINITION__NAME:
				return ArithmeticsPackage.DEFINITION__NAME;
			default:
				return -1;
			}
		}
