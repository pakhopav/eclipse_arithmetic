 ...
 * </p>
 * <ul>
 *   <li>{@link emf.arithmetics.impl.FunctionCallImpl#getFunc <em>Func</em>}</li>
 *   <li>{@link emf.arithmetics.impl.FunctionCallImpl#getArgs <em>Args</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionCallImpl extends ExpressionImpl implements FunctionCall {
		...
		if (func != null && func.eIsProxy()) {
			...
			if (func != oldFunc) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ArithmeticsPackage.FUNCTION_CALL__FUNC,
							oldFunc, func));
			}
		}
		return func;
	...
	public void setFunc(AbstractDefinition newFunc) {
		...
		func = newFunc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArithmeticsPackage.FUNCTION_CALL__FUNC, oldFunc,
					func));
	}
	...
	public EList<Expression> getArgs() {
		if (args == null) {
			args = new EObjectContainmentEList<Expression>(Expression.class, this,
					ArithmeticsPackage.FUNCTION_CALL__ARGS);
		}
		return args;
	}
