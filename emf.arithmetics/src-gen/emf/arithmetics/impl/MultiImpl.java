 ...
 * </p>
 * <ul>
 *   <li>{@link emf.arithmetics.impl.MultiImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link emf.arithmetics.impl.MultiImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultiImpl extends ExpressionImpl implements Multi {
	...
	public NotificationChain basicSetLeft(Expression newLeft, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ArithmeticsPackage.MULTI__LEFT, oldLeft, newLeft);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLeft != left) {
			...
			if (left != null)
				msgs = ((InternalEObject) left).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ArithmeticsPackage.MULTI__LEFT, null, msgs);
			if (newLeft != null)
	...
	public NotificationChain basicSetRight(Expression newRight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ArithmeticsPackage.MULTI__RIGHT, oldRight, newRight);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRight != right) {
			...
			if (right != null)
				msgs = ((InternalEObject) right).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ArithmeticsPackage.MULTI__RIGHT, null, msgs);
			if (newRight != null)
