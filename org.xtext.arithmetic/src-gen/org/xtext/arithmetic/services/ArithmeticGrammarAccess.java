 ...
 */
package org.xtext.arithmetic.services;
...
public class ArithmeticGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class ModuleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.arithmetic.Arithmetic.Module");
	...
	public class ImportElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.arithmetic.Arithmetic.Import");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class StatementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.arithmetic.Arithmetic.Statement");
	...
	public class DefinitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.arithmetic.Arithmetic.Definition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DeclaredParameterElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.arithmetic.Arithmetic.DeclaredParameter");
		private final Assignment cNameAssignment = (Assignment)rule.eContents().get(1);
		private final RuleCall cNameIDTerminalRuleCall_0 = (RuleCall)cNameAssignment.eContents().get(0);
		
		//DeclaredParameter lib::DeclaredParameter:
		//	name=ID;
		@Override public ParserRule getRule() { return rule; }
	...
	public class AbstractDefinitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.arithmetic.Arithmetic.AbstractDefinition");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cDefinitionParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cDeclaredParameterParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		
		//AbstractDefinition lib::AbstractDefinition:
	...
	public class EvaluationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.arithmetic.Arithmetic.Evaluation");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.arithmetic.Arithmetic.Expression");
	...
	public class AdditionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.arithmetic.Arithmetic.Addition");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//(({lib::Plus.left=current} '+' | {lib::Minus.left=current} '-') right=Multiplication)*
		public Group getGroup_1() { return cGroup_1; }
		
		//({lib::Plus.left=current} '+' | {lib::Minus.left=current} '-')
		public Alternatives getAlternatives_1_0() { return cAlternatives_1_0; }
		
		//{lib::Plus.left=current} '+'
	...
	public class MultiplicationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.arithmetic.Arithmetic.Multiplication");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//(({lib::Multi.left=current} '*' | {lib::Div.left=current} '/') right=PrimaryExpression)*
		public Group getGroup_1() { return cGroup_1; }
		
		//({lib::Multi.left=current} '*' | {lib::Div.left=current} '/')
		public Alternatives getAlternatives_1_0() { return cAlternatives_1_0; }
		
		//{lib::Multi.left=current} '*'
		public Group getGroup_1_0_0() { return cGroup_1_0_0; }
	...
	public class PrimaryExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.arithmetic.Arithmetic.PrimaryExpression");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		...
		//PrimaryExpression lib::Expression:
		//	'(' Expression ')' | {lib::NumberLiteral} value=NUMBER | {lib::FunctionCall} func=[lib::AbstractDefinition] ('('
	...
	public ArithmeticGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tNUMBER = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.arithmetic.Arithmetic.NUMBER");
		this.tINT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.arithmetic.Arithmetic.INT");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("org.xtext.arithmetic.Arithmetic".equals(grammar.getName())) {
				return grammar;
			}
