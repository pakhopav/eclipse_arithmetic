 ...
 */
package org.xtext.arithmetic.serializer;
...
public class ArithmeticSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == ArithmeticsPackage.eINSTANCE)
			...
			case ArithmeticsPackage.MODULE:
				sequence_Module(context, (emf.arithmetics.Module) semanticObject); 
				return; 
	 ...
	 */
	protected void sequence_Module(ISerializationContext context, emf.arithmetics.Module semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
